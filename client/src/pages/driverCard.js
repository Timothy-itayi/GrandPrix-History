...
const DriverCard = ({ driver, onClick }) => {
  return (
    ...
    >
      ...
      <p className="text-sm md:text-base text-gray-600 mb-1 text-center"><span className="font-bold">Driver Number:</span> {driver.driver_number}</p>
      <p className="text-sm md:text-base text-gray-600 mb-1 text-center"><span className="font-bold">Team:</span> {driver.teamName}</p>
      <p className="text-sm md:text-bsase text-gray-600 mb-1 text-center"><span className="font-bold">Points:</span> {driver.standing.points}</p>
