...
const DriverCard = ({ driver, onClick }) => {
  ...
  return (
    <div
      className="flex flex-col items-center bg-gray-800  shadow-lg rounded-lg p-4 md:p-6 transition-transform transform hover:scale-105 hover:scale-105 cursor-pointer"
      onClick={onClick}
