  ...
  return (
    ...
    <div className="py-10>
      <header className="text-center ">
        ...
        <div className="text-2xl text-gray-600 mb-6 text-white mx-auto max-w-3xl px-4">
          <p>Tracing the Thrills: Unveiling Formula 1's Historic Tracks and Cars</p>
        </div>
      </header>
      <div className="grid gap-4 md:flex md:flex-row md:flex-wrap justify-center">
        ...
        <section className="my-8 p-6 bg-white rounded-lg">
          ...
          <p className="text-gray-600 mb-4">
            Catch up with the Drivers Standings of the 2024 Formula 1 Season
          </p>
          <Link to="/drivers">
