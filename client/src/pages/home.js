...
const Home = () => {
  return (
    <div className="overflow-hidden py-20 animate-fade-up">
      ...
      <div className="grid gap-4 md:flex md:flex-row md:flex-wrap justify-center">
        ...
        <section className="my-8 p-6 bg-white rounded-lg">
          ...
          <Link to="/dashboard">
            <button className="bg-black text-white px-4 py-2 rounded hover:bg-green-600 transition duration-300">View Drivers</button>
          </Link>
        </section>
      </div>
      <footer className="text-center h- ">
        <p className="text-white">
          &copy; 2024 GrandPrix History. All rights reserved.
        </p>
      </footer>
    </div>
  );
