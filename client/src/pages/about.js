    ...
    return (
        <div className="text-center py-10">
            ...
            <div className="max-w-3xl mx-auto  text-lg text-gray-300">
                ...
                <p className="mt-10">
                 I would like to thank OpenF1 API for providing the current session data, HyperRace API for the current standings, ElevenLabs for the audio  and special regards to my  girlfriend Gracie for the support.
                </p>
            </div>
        </div>
    );
